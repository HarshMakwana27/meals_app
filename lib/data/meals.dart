...
const meals = [
  Meal(
    ...
    imageUrl:
        'https://media.istockphoto.com/id/1189079893/photo/aloo-paratha-with-lassi-indian-potato-stuffed-flatbread-with-butter-on-top-served-with-fresh.jpg?s=612x612&w=0&k=20&c=KS-HPML7jXEVCD4edsaaAj6uLVqZUI7sxdSf0CtQKsc=',
    duration: 15,
    ingredients: [
    ...
    steps: [
      'Mix mashed potatoes, chopped onion, green chilies, cumin seeds, red chili powder, and salt.',
      'Knead whole wheat flour with water to form a soft dough. Rest for 15-20 minutes.',
      'Divide dough and potato mixture into equal portions.',
      'Roll out a portion of dough, place potato mixture in the center, seal it.',
      'Roll it into a circular paratha, about 6-8 inches in diameter.',
      'Cook on a heated pan, applying ghee/oil, until golden brown spots appear on both sides.',
  ...
  Meal(
    ...
    imageUrl: 'https://www.laviadelte.com/uploaded/o/2383.jpg',
    duration: 5,
    ingredients: [
      '¼ cup- Milk',
      '1 cup      - Water',
      '2to 3 tsps - Tea powder ',
      'Sugar to taste',
